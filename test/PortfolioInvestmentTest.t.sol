...
contract PortfolioInvestmentTest is Test {
    ...
    function setUp() public {
        stable = new ERC20Mock("Stable", "STBL", user, 1000000e18);
        tokenA = new ERC20Mock("AssetA", "ASTA", address(this), 1000000e18);
        tokenB = new ERC20Mock("AssetB", "ASTB", address(this), 1000000e18);
