...
contract InvestmentTest is Test {
    ...
    address constant USER = 0x591b183B2443a070Ec57bDd7244B77FF92026Bd8;
    ...
    address constant WBTC_ADDRESS = 0x927B51f251480a681271180DA4de28D44EC4AfB8;
    address constant FTC_ADDRESS = 0x222bCfe6EF4bF34a0186C514c884a387c41CD985;
    ...
    function setUp() public {
        ...
        console.log("FTC BALANCE", IERC20(FTC_ADDRESS).balanceOf(UNIPOOL)); 
        console.log("WBTC BALANCE", IERC20(WBTC_ADDRESS).balanceOf(UNIPOOL)); 
    ...
    function testRebalance() public {
        ...
        uint256[] memory sellAmountsBps =  new uint256[](0);
        //sellAmountsBps[0] = 10000;
        address[] memory buyAssets =  new address[](1);
        buyAssets[0] = FTC_ADDRESS;
        //buyAssets[1] = WBTC_ADDRESS;
        uint256[] memory buyAmountsBps =  new uint256[](1);
        buyAmountsBps[0] = 10000;
       // buyAmountsBps[1] = 5000;
        unipoolContract.rebalance(sellAssets, sellAmountsBps, buyAssets, buyAmountsBps);
